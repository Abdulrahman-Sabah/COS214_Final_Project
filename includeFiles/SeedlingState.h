 ...
 * @details Inherits from PlantLifeCycleState, and represents the seedling state
 * of a plant lifecycle
 */
...
public:
   ...
   * @details if isDead() is true, moves to DeadState; else move to the
   * GrowingState
   */
