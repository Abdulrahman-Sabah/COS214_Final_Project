 ...
 * responsibility
 * @details Inherits from Handler and processes requests related to moving
 * plants to sales and managing the inventory
 */
...
public:
   ...
   * @details This method checks the command type and if it is valid it
   * processes it. If not, it passes the request to the next handler in the
   * chain.
   */
