 ...
 *
 * BasicPlant provides a straightforward implementation of the Plant abstract
 * class with basic properties and functionality. It can be used as a generic
 * plant type or as a base for more specialized plant implementations.
 */
