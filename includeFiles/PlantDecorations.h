 ...
 * @brief Abstract decorator class that allows adding features to plants dynamically
 * 
 * This class implements the Decorator pattern for the Plant hierarchy, allowing
 * additional features (like pots, cards, wrapping) to be added to plants at runtime
 * without modifying their original structure.
 */
